...
plt.figure()
plt.subplot(221), plt.imshow(img, cmap='gray'), plt.title('Imagen Original - Expandida')
...
plt.subplot(122,sharex=ax1,sharey=ax1), plt.imshow(img_warp, cmap="gray"), plt.title('Output')
plt.show(block=False)
