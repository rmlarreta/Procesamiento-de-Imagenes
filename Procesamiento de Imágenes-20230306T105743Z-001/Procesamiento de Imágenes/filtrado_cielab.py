...
while True:
    ...
    cv2.imshow(win_frame, cv2.resize(frame, dsize=(int(width / 3), int(height / 3))))
    cv2.imshow(win_mask, cv2.resize(frame_threshold, dsize=(int(width / 3), int(height / 3))))
    cv2.imshow(win_frame_filtrado, cv2.resize(frame_filtrado, dsize=(int(width / 3), int(height / 3))))
    cv2.imshow(win_frame_filtrado_neg, cv2.resize(frame_filtrado_neg, dsize=(int(width / 3), int(height / 3))))
